...
public class Sensors extends Subsystem {
	...
	// static Potentiometer pot = new AnalogPotentiometer(0, 360, 10); //Channel
	// number for Analog input, scale factor 360 being the great, offset to add
	// after scaling to prevent breakage (10 to 30 range)
	static AHRS navX;
	...
	/*
	 * public double getPot() { return pot.get(); }
	 */
	/*
	 * public ConfigFwdLimitSwitchNormallyOpen() { if(btn4) {
	 * customMotorDescrip.ConfigFwdLimitSwitchNormallyOpen(true); } else if(btn2) {
	 * customMotorDescrip.ConfigFwdLimitSwitchNormallyOpen(false); } if(btn1) {
	 * customMotorDescrip.ConfigRevLimitSwitchNormallyOpen(true); } elseif(btn3) {
